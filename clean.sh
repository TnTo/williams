...
sed "402,453 d" "In_the_Beginning_Was_the_Deed.txt" > "In_the_Beginning_Was_the_Deed_3.txt"
...
sed -n -e "392,440 p" -e "923,1008 p" -e "1221,1239 p" "The_Sense_of_the_Past.txt" > "The_Sense_of_the_Past_1.txt"
sed -n -e "1,141 p" -e "533,580 p" -e "1009,1162 p" -e "1240,1310 p" -e "1583,$ p" "The_Sense_of_the_Past.txt" > "The_Sense_of_the_Past_2.txt"
sed -e "1,141 d" -e "392,440 d" -e "533,580 d" -e "923,1162 d" -e "1221,1310 d" -e "1583,$ d" "The_Sense_of_the_Past.txt" > "The_Sense_of_the_Past_3.txt"
